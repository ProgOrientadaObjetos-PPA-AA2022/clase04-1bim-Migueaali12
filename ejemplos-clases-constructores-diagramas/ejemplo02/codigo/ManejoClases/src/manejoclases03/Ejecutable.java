...
public class Ejecutable {
    public static void main(String[] args) {
        // Se crea un objeto
        Computadora computadoraPersonal1 = new Computadora(120);
        Computadora computadoraPersonal2 = new Computadora("Ryzen 7");
        Computadora computadoraPersonal3 = new Computadora("Intel", 7);
        ...
        computadoraPersonal2.establecerMemoria(17 + 1);
